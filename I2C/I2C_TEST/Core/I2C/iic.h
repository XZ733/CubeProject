...
#define I2C_SCL_UP        HAL_GPIO_WritePin(GPIOC,GPIO_PIN_4,GPIO_PIN_SET)              //SCL高电平
#define I2C_SCL_LOW        HAL_GPIO_WritePin(GPIOC,GPIO_PIN_4,GPIO_PIN_RESET)            //SCL低电平
...
#define I2C_SCL        HAL_GPIO_ReadPin(GPIOC ,GPIO_PIN_4)        //获取SCL引脚状态
